                ...
                response.transactions.forEach((transaction) => {
                  ...
                  if (transactionSettings.get && thisTransactionSettings) {
                    ...
                    if (
                      ...
                      thisTransactionSettings.userCategories.length
                    ) {
                      transaction.category =
                        thisTransactionSettings.userCategories;
                    }
                    if (thisTransactionSettings.isReviewed) {
                      transaction.isReviewed =
                        thisTransactionSettings.isReviewed;
                    }
                    if (thisTransactionSettings.isDuplicate) {
                      transaction.isDuplicate =
                        thisTransactionSettings.isDuplicate;
                    }
                  }
