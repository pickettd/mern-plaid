    ...
    <div className="section">
      <div className="container">
        <p>
          ...
          Great care was taken to mālama this precious resource, ensuring proper
          management as it flowed from the mountains into loʻi to grow kalo and
          then into loko iʻa to grow fish.
        </p>
        <p>
          When there was plenty of water and that water was cared for, there was
          abundance or waiwai.
        </p>
        <p>
